    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`
            ...
            VALUES
                ...
                ('c3d4e5f6-7890-12f3-4567-89abcdef0123', 'Посмотрите новый дизайн', 'f647dfe1-85fc-4be1-bff2-ff42d7b89c6c', 'e6f78901-23ab-4cde-5f67-890123456789', '2025-04-03 9:35:00');
        `);
