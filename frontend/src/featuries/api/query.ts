...
import { ChatList, CreateChatDTO, MessagesDTO, PanelGroupButtons } from "../entities/schemes/dto/Chat";
...
export default class ApiQuery{
    ...
    static async createChat(chat: CreateChatDTO){
        const postedChat = (await authInstance.post(core.serverEdnpoints.allChats, chat)).data.chat
        return postedChat
    }

    static async sendMessage(context: string, chatId: string): Promise<MessagesDTO>{
